...
function howShot(){
  return '<img class="brandshot" alt="BUD&VIA" src="./budvia.jpg" onerror="this.onerror=null;this.src=(window.BUDVIA_ICON||\'\')"/>';
}
